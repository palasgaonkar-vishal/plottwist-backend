...
class TestBookAPI:
    ...
    def test_list_books_with_genre_filter(self, client: TestClient, sample_book: Book, sample_genre: Genre, db_session: Session):
    ...
    def test_list_books_with_rating_filter(self, client: TestClient, multiple_books: list[Book], db_session: Session):
    ...
    def test_search_books_with_multiple_filters(self, client: TestClient, sample_book: Book, sample_genre: Genre, db_session: Session):
    ...
    def test_create_book_success(self, client: TestClient, auth_headers: dict, sample_genre: Genre):
    ...
    def test_create_book_duplicate_isbn(self, client: TestClient, auth_headers: dict, sample_book: Book):
    ...
    def test_update_book_success(self, client: TestClient, auth_headers: dict, sample_book: Book, sample_genre: Genre):
        ...
        response = client.put(f"/api/v1/books/{sample_book.id}", json=update_data, headers=auth_headers)
    ...
    def test_delete_book_success(self, client: TestClient, auth_headers: dict, sample_book: Book):
...
class TestGenreAPI:
    ...
    def test_list_genres_success(self, client: TestClient, multiple_genres: list[Genre]):
