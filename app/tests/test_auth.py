...
# UserService imported but used only for reference in comments
...
class TestAuthService:
    ...
    def test_register_user_duplicate_email(self, db_session: Session):
        ...
        user_data2 = UserRegister(
            email="test@example.com", password="password456", name="Test User 2"
        )
    ...
    def test_login_inactive_user(self, db_session: Session, sample_user):
        ...
        login_data = UserLogin(email=sample_user.email, password="password123")
    ...
    def test_refresh_access_token_mismatched_token(
